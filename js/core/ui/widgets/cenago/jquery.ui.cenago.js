   ...
   createUI:function(){
	  ...
	  var 	cadena = '<div id="cenago_header" class="cenago-header cenago-resize cenago-transition">';
			...
			cadena+=	'		<div id="cenago_header_btnRight_ok_n" idref="" class="cenago-header-btn-inner sprite-cenago sprite-cenago-ok-m"></div>';
	   		...
	   		cadena+=	'</div>';
			cadena+=	'<div class="cenago-header-colors">';
			...
			cadena+= '	</div>';
	   		...
	   		cadena+= '	<div id="cenago_tab_vars" idref="var" class="cenago-resize cenago-tab sprite-cenago-vars"></div>';
	   		cadena+= '	<div id="cenago_tab_geo" idref="geo" class="cenago-resize cenago-tab sprite-cenago-geo"></div>';
	   		cadena+= '	<div id="cenago_tab_graph" idref="graph" class="cenago-resize cenago-tab sprite-cenago-graph"></div>';
	   		cadena+= '	<div id="cenago_tab_info" idref="info" class="cenago-resize cenago-tab sprite-cenago-binfo"></div>';
...
//print geoTypes
 ...
 //--------- Vars Display-----------------------------------------------------------------
  ...
  updateHeader:function(){
	...
	$('#cenago_subvar_title').html(svars.join('/'));
