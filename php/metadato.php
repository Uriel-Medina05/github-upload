...
<body>
<?php
$conn = pg_connect("host=127.0.0.1 dbname=ciegendata user=postgres password=postgres port=5433") or die('Could not connect: ' . pg_last_error());
...
$query = "SELECT titulo,propo,pclave,fman,fref,tfec,nconta,norga,pconta,clo,cle,cls,cln,sref,uref,datum,elipso,pproc,fuente,entatr FROM metadatos where id_capa='c_denue'";
//echo $query;
